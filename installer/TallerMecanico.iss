; Inno Setup script para instalador de TallerMecanico

#define MyAppName "TallerMecanico"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "TallerMecanico"
...
OutputDir=output
OutputBaseFilename=TallerMecanico-Setup
Compression=lzma
